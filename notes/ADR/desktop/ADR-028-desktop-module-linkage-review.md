...
- 日期: 2026-08-10 | 状态: P1-1/P2-1/P3-1 已修复（2026-08-10），条目已清 | 来源: 核查 src/NitroGateway.Desktop 与 Collection/Forwarder/MQTT/Device/Alarm/Persistence/Host 的事件、DI、生命周期联动（ADR-026/027 之后）
...
- P3-1 EventBridge 帧循环异常后永久停摆（已修复 2026-08-10，条目已清）: 帧循环改为 while + 重建 PeriodicTimer 重试（200ms 延迟），异常后自动恢复不再永久停摆（src/NitroGateway.Desktop/Messaging/EventBridge.cs）
